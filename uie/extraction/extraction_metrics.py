...
def get_extract_metrics(pred_lns: List[str], tgt_lns: List[str], label_constraint: RecordSchema, decoding_format='tree', tokenizer=None):
    predict_parser = get_predict_parser(decoding_schema=decoding_format, label_constraint=label_constraint, tokenizer=tokenizer)
    return eval_pred(
